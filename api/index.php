...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  } else if (!preg_match('/^https:\/\/github.com\/.*\.(js|css|json|html|htm|py|java|php|rb|cs|cpp|cxx|cc|swift|kt|kts|ts|tsx|go|rs|lua|scala|dart|sh|bash|ps1|pl|sql|yaml|yml|xml|md|r|rmd|m|coffee|haml|sass|scss|less|styl|stylus|vue|swift)$/', $link)) {
...
if ($cdnGenerated) {
  ...
  echo '<button type="button" class="btn btn-primary mr" onclick="copyCdnLink()">Copy to Clipboard</button>';
  echo '</div>';
}
