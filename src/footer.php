  ...
  <div class="container-fluid bg-light">
    <div class="row">
      <div class="col-12 text-center">
        ...
        <ul>
          <li><a href="https://patreon.com/KiasK?utm_medium=clipboard_copy&utm_source=copyLink&utm_campaign=creatorshare_creator&utm_content=join_link" target="_blank">Become a patron on Patreon</a></li>
          <li>Send cryptocurrency to the following address:
            <ul>
              <li>Ethereum, USDT, BUSD: 0x7c13a89b8E192e635ac24179B8DA6cC77101C651 on here</li>
            </ul>
          </li>
        </ul>
      </div>
